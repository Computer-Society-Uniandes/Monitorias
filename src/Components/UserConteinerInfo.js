...
const informacion = [
  {
    name: "Juan Pérez",
    subject: "Tutor de Cálculo Integral",
    sessions: 40,
    rating: 4.7,
    reviews: 10,
    price: 40000,
    description:
      "Hola, mi nombre es Juan. He sido monitor de cálculo diferencial e integral desde hace 2 años y llevo 1 año dando tutorías particulares. Estoy listo para ayudarlos con lo que necesiten, con la mejor disposición posible :)",
  },
  {
    name: "Juan Camilo",
