    ...
    <div className='background-profile'>
      ...
      <path fill="#1A237E" fill-opacity="1" d="M0,192L40,181.3C80,171,160,149,240,117.3C320,85,400,43,480,69.3C560,96,640,192,720,197.3C800,203,880,117,960,74.7C1040,32,1120,32,1200,64C1280,96,1360,160,1400,192L1440,224L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path>
        ...
        <div className="bg-white p-10 rounded inset-shadow-sm w-full mx-auto mt-5 max-w-3xl">
            ...
            <p className='text-info'><strong className='text-campos'>Nombre:</strong> </p>
            <p className='text-info'><strong className='text-campos'>Teléfono:</strong> </p>
            <p className='text-info'><strong className='text-campos'>Correo:</strong> </p>
